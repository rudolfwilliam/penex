...
from project_files.vision.imagenet.scripts.plotting.base import METHODS
...
if __name__ == "__main__":
    ...
    parser.add_argument("--baselines", type=str, choices=["standard"], default="standard", help="which baselines to plot")
