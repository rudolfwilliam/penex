...
from project_files.vision.cifar10.scripts.plotting.base import PARAMETER_ANALYSIS
...
def main():
    plot_metric_curves(
        wandb_project_name="cifar10_parameter_analysis",
        ...
        alphas=ALPHAS,
        zorders=ZORDERS,
        project_name="cifar10_parameter_analysis",
        fontsize=18
    )
