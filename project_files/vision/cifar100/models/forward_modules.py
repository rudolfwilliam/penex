...
class Cifar100ForwardModule(ForwardModule):
...
class Cifar100HardConstraintForwardModule(Cifar100ForwardModule):
...
class Cifar100SoftConstraintForwardModule(Cifar100ForwardModule):
